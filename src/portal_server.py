...
from src.portal.db.models import GroupMember # Keep GroupMember if it's used directly in this file
...
# Register security API routes - temporarily disabled due to syntax error
# try:
#     from src.api.security_api import register_security_api
#     register_security_api(app)
#     print("🛡️ Security API endpoints registered successfully")
# except ImportError as e:
#     print(f"⚠️ Security API not available: {e}")
print("⚠️ Security API temporarily disabled")
...
if __name__ == '__main__':
    ...
    print("-" * 50)
    print(f"🌐 Server starting on: {settings.PORTAL_SERVER_URL}")
