...
class NotificationAPI {
  ...
  private getCurrentUser(req: Request): { user_id: string; user_type: 'customer' | 'admin' } | null {
    // Check headers for API access
    const userId = req.headers.get('X-User-ID') || req.headers.get('X-Customer-ID');
    const adminId = req.headers.get('X-Admin-ID');
    const userType = req.headers.get('X-User-Type') as 'customer' | 'admin' || 'customer';
    ...
    const defaultTemplates: NotificationTemplate[] = [
      {
        ...
        message_template: 'Your {{transaction_type}} of ${{amount}} has been completed successfully.',
      ...
      },
      {
        ...
        message_template: 'Your account balance is ${{balance}}, which is below your threshold of ${{threshold}}.',
      ...
      },
      {
        ...
        message_template: 'A new login was detected from {{location}} at {{timestamp}}. If this wasn\'t you, please secure your account.',
      ...
      },
      {
        ...
        message_template: 'Your withdrawal request for ${{amount}} is being processed. Expected completion: {{eta}}.',
    ...
    const sampleNotifications: NotificationData[] = [
      {
        ...
        message: 'Your deposit of $500 has been confirmed and added to your account.',
        channels: [NotificationChannel.TELEGRAM, NotificationChannel.IN_APP],
      ...
      },
      {
        ...
        message: 'Your account balance is $150, which is below your alert threshold of $200.',
        channels: [NotificationChannel.IN_APP],
