...
def add_telegram_group():
    ...
    try:
        ...
        if telegram_monitor:
            # Note: This should be made async in future versions
            success = telegram_monitor.add_group_to_monitor(int(chat_id))
            if success:
...
def send_telegram_message():
    ...
    try:
        ...
        if admin_interface:
            # Note: This should be made async in future versions
            result = admin_interface.send_message(chat_id, text)
...
def get_chat_analytics(chat_id):
    ...
    try:
        ...
        if admin_interface:
            # Note: This should be made async in future versions
            analytics = admin_interface.get_chat_analytics(chat_id, days)
