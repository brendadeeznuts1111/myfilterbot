...
export function Dashboard() {
  ...
  const { data: _systemHealth } = useAPI('/health');
                ...
                <div className='flex items-center'>
                  ...
                  <div className='ml-3'>
                    ...
                    <p className='mt-1 text-sm text-red-700 dark:text-red-300'>
                      Some dashboard data could not be loaded. Using cached data
                      where available.
                    </p>
                    <button
                      onClick={refresh}
                        ...
                        <div>
                          <div className='flex justify-between text-sm'>
                            ...
                            <span className='font-medium text-gray-900 dark:text-white'>
                              {displayAnalytics?.performance_metrics?.roi_percentage?.toFixed(
                                2
                              ) || '0.00'}
                              %
                            </span>
                          ...
                          <div className='mt-1 w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2'>
                            <div
                              className={`h-2 rounded-full ${
                                (displayAnalytics?.performance_metrics
                                  ?.roi_percentage || 0) >= 0
                                  ? 'bg-green-500'
                                  : 'bg-red-500'
                              }`}
          ...
          {lastUpdate && (
            <div className='mt-8 text-center'>
              <p className='text-xs text-gray-500 dark:text-gray-400'>
                Last updated:{' '}
                {new Date(lastUpdate.timestamp || Date.now()).toLocaleString()}
